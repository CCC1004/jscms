	...
	<head>
        ...
        <script type="text/javascript">	
							...
							//alert('aaaa');
					 		if(data.fileExist!=null&&data.fileExist!=""){
					 			...
					 			if(confirm(str)){
					 			 ...
					 			 alert("文件上传成功！");
					 			/*window.close();	 */
					 			window.parent.uploadSuccessBack('1');
							}
			            }else{
				...
				$('#form1').ajaxSubmit({
					...
					success: function(data) {
						...
						if(data.success){		
					 		...
					 		alert(str);	
					 		/*window.close();	 */
							window.parent.uploadSuccessBack('2');
			            }else{
			...
			function setIdAndSubmit(id){
				...
				//window.parent.uploadSuccessBack(11);
				submitForm();
			}
			function setIdTest(id){
				/* $("input[name='send_id']").val(id);
				//window.parent.uploadSuccessBack(11);
				submitForm(); */
				alert(id);
...
<body onload=" valid= new Validation('form1', {onSubmit:false}); ">
    ...
    <s:form method="post" name="form1" id="form1" enctype="multipart/form-data">  	
    	<div class="list1">
	        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableContent" style="font-size: 12px">
	          	<tr height="25">
	             <td width="100px" class="titleStyle">&nbsp;&nbsp;文件标题：</td>
	            ...
	            <td class="td_padding_right list1_td_style">&nbsp;&nbsp;上传文件：</td>
