...
-- Records of fldlist
-- ----------------------------
INSERT INTO `fldlist` VALUES ('ADDV', 'ADDVCD', '行政分区编码', null, '1', null, '0', null, null, null, null, null, '0', null, '0', '0', null);

-- ----------------------------
-- Table structure for js_address
-- ----------------------------
DROP TABLE IF EXISTS `js_address`;
CREATE TABLE `js_address` (
  `GUID` char(32) NOT NULL COMMENT 'GUID',
  `ADDRNAME` varchar(30) NOT NULL COMMENT '地区名称',
  `STATUS` char(1) NOT NULL COMMENT '状态（是否显示：1：显示；2：不显示）',
  `TS` datetime NOT NULL COMMENT '时间戳',
  `NT` varchar(255) DEFAULT NULL COMMENT '备注',
  `SORT` char(3) DEFAULT NULL COMMENT '排序字段',
  PRIMARY KEY (`GUID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of js_address
-- ----------------------------
INSERT INTO `js_address` VALUES ('221a741d5f1743ffa4ebf36ffb6e487a', '北京', '1', '2018-08-18 14:18:18', '', '101');
INSERT INTO `js_address` VALUES ('64895316631e4713b1d1fe7155975611', '深圳', '1', '2018-08-18 14:18:46', '', '104');
INSERT INTO `js_address` VALUES ('b7c8a9f812ae402b920cafd8e1668362', '广州', '1', '2018-08-18 14:18:38', '', '103');
INSERT INTO `js_address` VALUES ('d0ad26a364554d91a72eeb662486e112', '上海', '1', '2018-08-18 14:18:29', '', '102');
INSERT INTO `js_address` VALUES ('ee3e750c4ed745eca33c490191ae18b5', '杭州', '1', '2018-08-18 14:18:58', '', '105');

-- ----------------------------
-- Table structure for js_job
-- ----------------------------
DROP TABLE IF EXISTS `js_job`;
CREATE TABLE `js_job` (
  `GUID` char(32) NOT NULL COMMENT 'GUID',
  `JOBNAME` varchar(30) NOT NULL COMMENT '工作名称',
  `STATUS` char(1) NOT NULL COMMENT '状态（是否显示：1：显示；2：不显示）',
  `TS` datetime NOT NULL COMMENT '时间戳',
  `NT` varchar(255) DEFAULT NULL COMMENT '备注',
  `SORT` char(3) DEFAULT NULL COMMENT '排序字段',
...
-- Records of js_job
-- ----------------------------
INSERT INTO `js_job` VALUES ('5b20dc8e933b477abfb18ccefd354cc3', '中年人', '1', '2018-08-18 14:16:43', '', '104');
INSERT INTO `js_job` VALUES ('7cb808012766421798b285aa3dea8e3f', '上班族', '1', '2018-08-18 14:16:29', '', '103');
INSERT INTO `js_job` VALUES ('c94435ddd05f4ddaaf1dd8c2dcb31cb1', '老年人', '1', '2018-08-18 14:16:56', '', '105');
INSERT INTO `js_job` VALUES ('d96fe060284c4df9853ad9d81938b919', '程序员', '1', '2018-08-18 14:15:12', '', '102');
INSERT INTO `js_job` VALUES ('f9c0606cae864c689a71cd65e2fc246e', '学生党', '1', '2018-08-18 14:11:00', '', '101');
...
-- Records of js_role
-- ----------------------------
INSERT INTO `js_role` VALUES ('0541e54963ee46869dd9db123368981b', '种子选手', '1', '2018-08-18 13:58:57', '', '102');
INSERT INTO `js_role` VALUES ('05ccee5f77c442549996cb6c4296c7c6', '健身大神', '1', '2018-08-18 14:10:18', '', '104');
INSERT INTO `js_role` VALUES ('cc08b694d87e46caa42d0da27996f86e', '健身顾问', '1', '2018-08-18 14:00:03', '', '103');
INSERT INTO `js_role` VALUES ('fac1966be0924044b240ed4cfd4dafd0', '菜鸟', '1', '2018-08-18 12:15:47', '', '101');

-- ----------------------------
-- Table structure for js_type
-- ----------------------------
DROP TABLE IF EXISTS `js_type`;
CREATE TABLE `js_type` (
  `GUID` char(32) NOT NULL COMMENT 'GUID',
  `TYPENAME` varchar(30) NOT NULL COMMENT '健身类型名称（减肥/增肌...）',
  `STATUS` char(1) NOT NULL COMMENT '状态（是否显示：1：显示；2：不显示）',
  `TS` datetime NOT NULL COMMENT '时间戳',
  `NT` varchar(255) DEFAULT NULL COMMENT '备注',
  `SORT` char(3) DEFAULT NULL COMMENT '排序字段',
...
-- Records of js_type
-- ----------------------------
INSERT INTO `js_type` VALUES ('223b7cfcdb2d43c49a2100c69d00c697', '减肥', '1', '2018-08-18 14:17:40', '', '103');
INSERT INTO `js_type` VALUES ('cb2e75d3b1b74b35babcee335973431c', '游客', '1', '2018-08-18 14:17:18', '', '101');
INSERT INTO `js_type` VALUES ('d52e9517d9fe4a5daf5ffd19ce7e3f60', '塑身', '1', '2018-08-18 14:17:30', '', '102');
INSERT INTO `js_type` VALUES ('f708eaa6a39c4160bea9e51beaa38877', '增肌', '1', '2018-08-18 14:17:50', '', '104');

-- ----------------------------
-- Table structure for js_userinfo
-- ----------------------------
DROP TABLE IF EXISTS `js_userinfo`;
CREATE TABLE `js_userinfo` (
  `GUID` char(32) NOT NULL COMMENT '健身用户ID',
  `NAME` varchar(20) NOT NULL COMMENT '用户名',
  `AGE` int(3) NOT NULL COMMENT '年龄',
  `SEX` char(1) NOT NULL COMMENT '性别（1：男；2：女）',
  `ADDR_CD` char(32) NOT NULL COMMENT '地区代码',
  `ROLE_CD` char(32) NOT NULL COMMENT '角色代码',
  `JOB_CD` char(32) NOT NULL COMMENT '职业代码',
  `TYPE_CD` char(32) NOT NULL COMMENT '健身类型代码',
  `STATUS` char(1) NOT NULL COMMENT '状态（1：显示；2：不显示）',
  `TS` datetime NOT NULL COMMENT '时间戳',
  `NT` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`GUID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sys_code` VALUES ('SHOW_STATUS', '1', '显示', '', '1');
INSERT INTO `sys_code` VALUES ('SHOW_STATUS', '2', '不显示', '', '2');
...
INSERT INTO `sys_dict` VALUES ('SHOW_STATUS', '显示状态');
...
INSERT INTO `sys_menu` VALUES ('130bb0e5168c4b4da8e9bc4f7f91c0ed', '类型管理', 'QLListView_JS_TYPE.List.qact', '', '3', '', '56a7f283e62a4b27a04ea68a6743dfe9', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('4024bb545c204eb58d486c6288103693', '职业管理', 'QLListView_JS_JOB.List.qact', '', '2', '', '56a7f283e62a4b27a04ea68a6743dfe9', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('46f7e9edd24c4f26935e47dbe5282975', '角色管理', 'QLListView_JS_ROLE.List.qact', '', '1', '', '56a7f283e62a4b27a04ea68a6743dfe9', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('56a7f283e62a4b27a04ea68a6743dfe9', '登录信息维护', '', '', '1', '', '9df12c8efaa24b6b853197865426b71f', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('9314cf75c93f4af187888d1aec924257', '地区管理', 'QLListView_JS_ADDRESS.List.qact', '', '4', '', '56a7f283e62a4b27a04ea68a6743dfe9', '', '1', '1');
