...
INSERT INTO `sys_menu` VALUES ('4024bb545c204eb58d486c6288103693', '污水处理场管理', '', '', '2', '', '9df12c8efaa24b6b853197865426b71f', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('46f7e9edd24c4f26935e47dbe5282975', '排水户管理', '', '', '1', '', '9df12c8efaa24b6b853197865426b71f', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('4c60c264a6764987a48a736159202d65', '排口管理', '', '', '2', '', '0ad0ac3ae6fc4941b0ba415bb44fa988', '', '1', '1');
INSERT INTO `sys_menu` VALUES ('5                              1', '菜单管理', null, null, '2', '5                             ', '6ba86480cc2b49e9bcb86b44e1b2a16a', null, null, '1');
INSERT INTO `sys_menu` VALUES ('501faf84472345d08c4100ff6c11b1c4', '政区排口统计', '', '', '1', '', '20b69cf0fa05407eb42a9111951db113', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('7403520f253546e68befdf133f4f0c44', '一张图', '', 'pageframe/images/home/icon/2.png', '1', '', '', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('ae0f584b76c34e4e9361c52793545d7b', '排口登记', '', '', '1', '', '0ad0ac3ae6fc4941b0ba415bb44fa988', '', '1', '1');
INSERT INTO `sys_menu` VALUES ('be9d968087434cf9a0deaaaba311ecd6', '河湖排口统计', '', '', '2', '', '20b69cf0fa05407eb42a9111951db113', '', '1', '1');
...
INSERT INTO `sys_menu` VALUES ('ed529941ecca4323b8e935ee273f9235', '同期对比分析', '', '', '3', '', '20b69cf0fa05407eb42a9111951db113', '', '1', '1');
...
-- ----------------------------
-- View structure for vm_mn_awqmd_wqmd
-- ----------------------------
DROP VIEW IF EXISTS `vm_mn_awqmd_wqmd`;
CREATE ALGORITHM=UNDEFINED DEFINER=`whpk`@`%` SQL SECURITY DEFINER VIEW `vm_mn_awqmd_wqmd` AS select distinct `mn`.`STID` AS `STID`,`mn`.`TM` AS `TM`,`mn`.`WT` AS `WT`,`mn`.`PH` AS `PH`,`mn`.`CODMN` AS `CODMN`,`mn`.`CODCR` AS `CODCR`,`mn`.`NH3N` AS `NH3N`,`mn`.`VLPH` AS `VLPH`,`mn`.`TP` AS `TP`,`mn`.`TN` AS `TN`,`mq`.`Q` AS `Q`,`pf`.`PDO_CD` AS `PDO_CD`,`pf`.`PDO_NM` AS `PDO_NM`,`pf`.`ADDVCD` AS `ADDVCD`,`pf`.`RVCD` AS `RVCD`,`pf`.`LKCD` AS `LKCD`,`pf`.`POW_TP` AS `POW_TP` from (((`mn_awqmd_wqmd` `mn` left join `mn_st_mq_rmd` `mq` on(((`mn`.`STID` = `mq`.`STCD`) and (`mn`.`TM` = `mq`.`TM`)))) left join `bs_pdo_stat_rel` `rel` on((`mn`.`STID` = `rel`.`STCD`))) left join `pf_rosd_pdo_b` `pf` on((`rel`.`PDO_CD` = `pf`.`PDO_CD`))) ;
